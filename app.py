...
class Application:
    def __init__(self):
        ...
        self.root.geometry("900x1500")
        self.panel = tk.Label(self.root)
        self.panel.place(x = 135, y = 10, width = 640, height = 540)
    ...
    def video_loop(self):
        ...
        if ok:
            ...
            predict=self.hs.suggest(self.current_symbol)
    ...
    def predict(self,test_image):
        ...
        # converter.setProperty('rate', 150)
        # converter.setProperty('volume', 0.7)
        # converter.say(self.current_symbol)
        # converter.runAndWait()
        #LAYER 2
    ...
    def action_call(self) :
        ...
        # img = cv2.imread("Pictures/abhishesh.jpg", 1)
        # img = cv2.resize(img, (300, 300))
        # cv2.imwrite("Pictures/abhishesh.png", img)
        # return 
        ...
        self.photo1 = tk.PhotoImage(file='Pictures/sukhi.png')
        ...
        self.tx6.config(text = "Sukhchandra\nBCE17070136", font = ("Courier",15,"bold"))

        self.photo2 = tk.PhotoImage(file='Pictures/supriya.png')
        ...
        self.tx2.config(text = "Supriya\nBCE17110039", font = ("Courier",15,"bold"))

        
        self.photo3 = tk.PhotoImage(file='Pictures/sweta.png')
        ...
        self.tx3.config(text = "Sweta\nBCE17070143", font = ("Courier",15,"bold"))

        self.photo4 = tk.PhotoImage(file='Pictures/abinish.png')
        ...
        self.tx4.config(text = "Abnish\nBCE17070100", font = ("Courier",15,"bold"))
        ...
        self.photo6 = tk.PhotoImage(file='Pictures/abhishesh.png')
        self.w6 = tk.Label(self.root1, image = self.photo6)
        self.w6.place(x = 350, y = 420)
        self.tx6 = tk.Label(self.root1)
        self.tx6.place(x = 230,y = 670)
        self.tx6.config(text = "Er. Abhishesh Dahal", font = ("Courier",30,"bold"))
